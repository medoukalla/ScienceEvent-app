            ...
            <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
              <ul role="list" class="nav-menu w-list-unstyled">
                <li class="nav-mobile-brand"><a href="/home-pages/home-one" class="navbar-brand w-nav-brand"><img
                      loading="lazy"
                      src="{{ asset('assets/images/logo-science-events.png') }}"
                  ...
                  <div data-delay="500" data-hover="false" data-w-id="b209fa0f-e639-eccc-0896-595290f492c0"
                    ...
                    <nav class="nav-dropdown-list w-dropdown-list">
                      <div class="nav-dropdown-link-wrapper mega-menu">
                        <div class="nav-y">
                          <a href="/home-pages/home-one" data-w-id="b209fa0f-e639-eccc-0896-595290f492c8"
                            class="nav-dropdown-link-block w-inline-block">
                            <div class="nav-dropdown-shape"></div>
                            <div class="nav-dropdown-link-text">
                              <img src="{{ asset('assets/svg/medecin.svg') }}" alt="">
                              <span>Médecin</span>
                            </div>
                          </a>
                          <a href="/home-pages/home-one" data-w-id="b209fa0f-e639-eccc-0896-595290f492c8"
                            ...
                            <div class="nav-dropdown-shape"></div>
                            <div class="nav-dropdown-link-text">
                              <img src="{{ asset('assets/svg/nurse.svg') }}" alt="">
                              <span>Ifirmier</span>
                            </div>
                          </a>
                          <a href="/home-pages/home-one" data-w-id="b209fa0f-e639-eccc-0896-595290f492c8"
                            ...
                            <div class="nav-dropdown-shape"></div>
                            <div class="nav-dropdown-link-text">
                              <img src="{{ asset('assets/svg/officine.svg') }}" alt="">
                              <span>Officine</span>
                            </div>
                          </a>
                          <a href="/home-pages/home-one" data-w-id="b209fa0f-e639-eccc-0896-595290f492c8"
                            ...
                            <div class="nav-dropdown-shape"></div>
                            <div class="nav-dropdown-link-text">
                              <img src="{{ asset('assets/svg/aide.svg') }}" alt="">
                          ...
                          <a href="/home-pages/home-one" data-w-id="b209fa0f-e639-eccc-0896-595290f492c8"
                            ...
                            <div class="nav-dropdown-shape"></div>
                            <div class="nav-dropdown-link-text">
                              <img src="{{ asset('assets/svg/sante.svg') }}" alt="">
                          ...
                          <a href="/home-pages/home-one" data-w-id="b209fa0f-e639-eccc-0896-595290f492c8"
                            ...
                            <div class="nav-dropdown-link-text">
                              <img src="{{ asset('assets/svg/sante.svg') }}" alt="">
                              <span>Etablissment de santé</span>
                            </div>
                          </a>
                        </div>
                        <div class="nav-content">
                          <div class="top-mega">
                            <div class="a-la-une">À la une</div>
                            <div class="top-mega-tags">
                              <div class="mega-tag selected">
                                Ville
                              </div>
                              <div class="mega-tag">Etablissement</div>
                            </div>
                          </div>
                          <div class="nav-content-wrapper">
                            <div class="menu-result">
                              ...
                              <div class="result-img-wrapper">
                                <img src="{{ asset('assets/images/reslut-img.png') }}" alt="Result image">
                                <div class="reslut-content">
                                  <div class="result-title">Lorem ipsum dolor sit amet.</div>
                                  <div class="result-duration">
                                    <div class="formation-content">
                                      <img src="{{ asset('assets/svg/tips.svg') }}" alt="Aide icon">
                                      Formation continue
                                    </div>
                                    <div class="duration">
                                      <img src="{{ asset('assets/svg/dorution-icon.svg') }}" alt="duration icon">
                                      <span>11 heures</span>
                                    </div>
                                  </div>
                                  <div class="result-tags">
                                    <div class="r-tag">DPC</div>
                                    <div class="r-tag">FIF PL</div>
                                    <div class="r-tag">Crédit d'impôt</div>
                                  </div>
                                </div>
                              </div>
                              <!-- Button more results -->
                      ...
                      <div>
                        ...
                        <div class="similar-result-wrapper">
                          <div class="similar-result">
                            <div class="s-r-img">
                              <img src="{{ asset('assets/images/s-result.png') }}" alt="Similar result">
                            </div>
                            <div class="s-r-content">
                              ...
                              <div class="s-r-duration">
                                <div class="duration tag">
                                  <img src="{{ asset('assets/svg/dorution-icon.svg') }}" alt="">
                                  <span>12 heures</span>
                                </div>
                                <div class="programme tag">
                                  <img src="{{ asset('assets/svg/programme-icon.svg') }}" alt="">
                                  <span>Programme intégre</span>
                                </div>
                              </div>
                              <div class="s-r-tags">
                                <div class="r-tag">DPC</div>
                                <div class="r-tag">Crédit d'impot</div>
                              </div>
                            </div>
                          </div>
                          <div class="similar-result">
