...
! function() {
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, r) {
                var o = a.project_img,
                    s = a.project_name,
                    i = a.date;
                return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar avatar-sm me-3">' + (o ? '<img src="' + assetsPath + "img/icons/brands/" + o + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (o = (((o = (s = a.project_name).match(/\b\w/g) || []).shift() || "") + (o.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><h6 class="text-truncate mb-0">' + s + '</h6><small class="text-truncate">' + i + "</small></div></div>"
            }
        }, {
            targets: 3,
            render: function(e, t, a, r) {
            ...
            searchable: !1,
            render: function(e, t, a, r) {
                for (var o = a.team, s = "", i = 0, n = 0; n < o.length && (s += '<li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kim Karlos" class="avatar avatar-sm pull-up"><img class="rounded-circle" src="' + assetsPath + "img/avatars/" + o[n] + '"  alt="Avatar"></li>', !(2 < ++i)); n++);
                return 2 < i && 0 < (a = o.length - 3) && (s += '<li class="avatar avatar-sm"><span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip" data-bs-placement="top" title="' + a + ' more">+' + a + "</span ></li>"), '<div class="d-flex align-items-center"><ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">' + s + "</ul></div>"
            }
        }, {
            targets: -2,
            render: function(e, t, a, r) {
    ...
    }), $("div.head-label").html('<h5 class="card-title mb-0">Project List</h5>')), setTimeout(() => {
