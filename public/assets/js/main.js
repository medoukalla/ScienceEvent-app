        ...
        s.length && s.on("click", function() {
            ...
            o.typeahead({
                ...
                templates: {
                    ...
                    notFound: '<div class="not-found px-4 py-2"><h6 class="suggestions-header text-primary mb-2">Pages</h6><p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i> No Results Found</p></div>'
                }
            }, {
                name: "files",
                display: "name",
                ...
                templates: {
                    ...
                    notFound: '<div class="not-found px-4 py-2"><h6 class="suggestions-header text-primary mb-2">Files</h6><p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i> No Results Found</p></div>'
                }
            }, {
                name: "members",
                display: "name",
                ...
                templates: {
                    ...
                    notFound: '<div class="not-found px-4 py-2"><h6 class="suggestions-header text-primary mb-2">Members</h6><p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i> No Results Found</p></div>'
                }
                ...
                o.val(""), e.typeahead("val", ""), n.addClass("d-none"), i.addClass("fade").removeClass("show")
            }), o.on("keyup", function() {
